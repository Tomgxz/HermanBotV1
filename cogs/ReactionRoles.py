...
class ReactionRoles(commands.Cog):
    ...
    async def reaction(
        ...
        embed=discord.Embed(title="General Roles", description="React to gain them :)", color=0x00ff33)
        embed.add_field(name=":mens:", value="He/him", inline=True)
        embed.add_field(name=":womens:", value="She/her", inline=True)
        embed.add_field(name=":restroom:", value="They/them", inline=True)
        embed.add_field(name=":video_game:", value="Gamer", inline=True)
        embed.add_field(name=":movie_camera:", value="Streamer", inline=True)
        embed.add_field(name=":computer:", value="Youtuber", inline=True)
        embed.set_footer(text="HERMAN THE WORMAN")
    ...
    def add_reaction(self, guild_id, emote, role_id, channel_id, message_id):
        ...
        #await message_id.add_reaction(emote)
        store_reaction_roles()
