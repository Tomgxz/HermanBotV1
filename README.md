# Herman the Worman bot written in discord.py

This code uses the discord.py [command extension] (https://discordpy.readthedocs.io/en/latest/ext/commands/commands.html) and [cogs](https://discordpy.readthedocs.io/en/latest/ext/commands/cogs.html)
